...
Updates are offered from the public GitHub releases of this project through the normal WordPress plugin update screen.
...
## 0.2.4
- Añade comprobación de actualizaciones desde las releases públicas de GitHub.
